import type { TileMap, Position, MonsterState, Direction } from '../../utils/types';
import { TileType } from '../../utils/types';

export type InteractionResult =
  | { readonly kind: 'none' }
  | { readonly kind: 'chest'; readonly position: Position }
  | { readonly kind: 'monster'; readonly monsterIndex: number; readonly monster: MonsterState }
  | { readonly kind: 'stairs' }
  | { readonly kind: 'event'; readonly tileType: TileType; readonly position: Position }
